        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/support/sales" className="text-muted-foreground hover:text-primary transition-colors">
                  Sales Team
                </Link>
              </li>
              <li>
                <Link href="/become-partner" className="text-muted-foreground hover:text-primary transition-colors">
                  Become Partner
                </Link>
              </li>
            </ul>
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold text-foreground mb-4">Ajunet India Pvt. Ltd.</h3>
            <p className="text-muted-foreground mb-2 font-medium">
              Connecting Networks, Empowering Business
            </p>
            <p className="text-muted-foreground mb-4">
              Leading provider of innovative networking solutions and cutting-edge technology infrastructure for enterprises across India. We deliver reliable, scalable, and secure networking solutions that drive digital transformation.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-muted-foreground text-sm">
              © {currentYear} Ajunet India Pvt. Ltd.
            </p>
